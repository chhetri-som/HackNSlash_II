...
public class UI {
	...
	public UI(GamePanel gp) {
		...
		// initialize fonts
		try {
			InputStream  is = getClass().getResourceAsStream("/font/MVBOLI.TTF");
			MV_Boli = Font.createFont(Font.TRUETYPE_FONT, is);
			
			is = getClass().getResourceAsStream("/font/SITKA.TTC");
			SITKA = Font.createFont(Font.TRUETYPE_FONT, is);
	...
	public void drawMessage() {
		...
		for(int i = 0; i < message.size(); i++) {
			if (message.get(i) != null) {
				...
				int counter = messageCounter.get(i) + 1; //basically i++
	...
	public void drawTitleScreen() {
		...
		g2.setColor(new Color(65, 20, 22));
		g2.fillRect(0, 0, gp.screenWidth, gp.screenHeight);
		g2.setFont(SITKA);
		g2.setFont(g2.getFont().deriveFont(Font.PLAIN, 60F));
		
		String text = "Hack & Slash";
		...
		g2.drawImage(gp.player.sword, x, y, gp.tileSize * 4, gp.tileSize * 4, null);
	...
	public void drawCharacterScreen() {
		...
		g2.drawString("Next lvl", textX, textY);  textY += lineHeight;
	...
	public void drawGameOverScreen() {
		...
		g2.setColor(new Color(20, 0, 0, 150));
		g2.fillRect(0, 0, gp.screenWidth, gp.screenHeight);
	...
	public void options_fullScreenNotification(int frameX, int frameY) {
		...
		currentDialogue = "For the change to occur, \nplease manually restart \ngame.";
	...
	public void options_control(int frameX, int frameY) {
		...
		g2.drawString("Shoot Fire", textX, textY); textY += gp.tileSize;
	...
	public void drawSubWindow(int x, int y, int width, int height) {
		...
		Color c = new Color(65, 75, 80, 220);
		g2.setColor(c);
